...
const ImplementosViales = () => {
  ...
  const implementosViales = implementos.filter(
    (implemento) => implemento.categoria === "implementos-viales"
    ...
    <>
      ...
      <div className="container mt-4">
        <input
                ...
                />
        <div className="row">
          {implementosViales.map((implemento) => (
            <div
              key={implemento.id}
...
export default ImplementosViales;
