...
const Niveladora = () => {
  ...
  const implementosNiveladora = implementos.filter(
    (implemento) => implemento.subcategoria === "niveladora"
  );
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        <div className="row">
          {implementosNiveladora.map((implemento) => (
            <div
              key={implemento.id}
