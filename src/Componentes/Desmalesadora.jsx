...
const Desmalesadora = () => {
  ...
  const implementosDesmalesadora = implementos.filter(
    (implemento) => implemento.subcategoria === "desmalesadora"
  );
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        <div className="row">
          {implementosDesmalesadora.map((implemento) => (
            <div
              key={implemento.id}
