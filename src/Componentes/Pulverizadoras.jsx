...
const Pulverizadoras = () => {
  ...
  const tractoresPulverizadoras = tractores.filter(tractor => tractor.subcategoria === "pulverizadoras");
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        <div className="row">
          {tractoresPulverizadoras.map((tractor) => (
