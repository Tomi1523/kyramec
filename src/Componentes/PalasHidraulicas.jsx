...
const PalasHidraulicas = () => {
  ...
  const implementosPalas = implementos.filter(
    (implemento) => implemento.subcategoria === "pala-hidraulica"
  ...
  return (
    <>
      ...
      <div className="container mt-4">
        <div className="row">
          {implementosPalas.map((implemento) => (
            <div
              key={implemento.id}
...
export default PalasHidraulicas;
